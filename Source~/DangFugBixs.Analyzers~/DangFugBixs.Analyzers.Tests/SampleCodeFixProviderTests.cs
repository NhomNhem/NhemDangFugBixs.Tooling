...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<DangFugBixs.Analyzers.SampleSyntaxAnalyzer,
        DangFugBixs.Analyzers.SampleCodeFixProvider>;

namespace DangFugBixs.Analyzers.Tests;
