...
internal static class RegistrationEmitter {
    public static string GenerateSource(
        ...
        writer.WriteLine("// Generated by NhemDangFugBixs.Tooling v3.1");
        writer.WriteLine("// Type-safe scope references with cross-assembly discovery");
        writer.WriteLine();
                ...
                var mappedServices = services.Select(s => {
                    if (s.UsesTypeSafeScope && scopeMappings != null) {
                        ...
                        if (!string.IsNullOrEmpty(mapping.ClassName)) {
                            // Map to the concrete LifetimeScope name for grouping
                            return new ServiceInfo(
                                ...
                                s.IsFactory, mapping.ClassName, true);
                        }
                    }
                    return s;
                });
