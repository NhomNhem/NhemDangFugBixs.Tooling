...
### DangFugBixs.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [DangFugBixs.Analyzers.Sample.csproj](../DangFugBixs.Analyzers.Sample/DangFugBixs.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### DangFugBixs.Analyzers.Tests
