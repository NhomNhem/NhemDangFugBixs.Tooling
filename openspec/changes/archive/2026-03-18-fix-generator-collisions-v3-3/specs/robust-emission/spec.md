...
- **THEN** it uses `global::NhemDangFugBixs.Attributes.NhemLifetime.Singleton` and `public static partial class VContainerRegistration` and `public static partial class SceneInjectionBlueprint`
